...
public:
    // Default constructor
    Account() : accountNumber(nextAccountNumber++), accountHolderName(""), balance(0.0) {
        cout << "Default Constructor called. this pointer: " << this << endl;
    }

    // Parameterized constructor
    Account(string accName, double bal) 
        : accountNumber(nextAccountNumber++), accountHolderName(accName), balance(bal) {
